bosh-genesis-kit deployments
==============================

This repository contains the YAML templates that make up a series of
bosh-genesis-kit BOSH deployments, using the format prescribed by the
[Genesis][1] utility. These deployments are based off of the
[bosh-genesis-kit-genesis-kit][2].
...
To create a new environment (called us-east-prod-bosh-genesis-kit):
...
To download a new version of the kit, and deploy it:
    ...
    genesis download bosh-genesis-kit [version] # omitting version downloads the latest
...
- [bosh-genesis-kit-genesis-kit][2] - Details on the kit used in this repo,
...
[2]: https://github.com/genesis-community/bosh-genesis-kit-genesis-kit
